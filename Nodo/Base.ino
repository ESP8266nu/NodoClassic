...
#define NODO_VERSION_MINOR                10 // was 11!                          // Ophogen bij gewijzigde settings struct of nummering events/commando's. 
...
#define CMD_DELAY_MS                    55 // Nodo Classic
...
prog_char PROGMEM Cmd_55[]="Delayms"; // Nodo Classic
